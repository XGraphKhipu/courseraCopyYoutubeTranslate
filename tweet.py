...
def GetConsumerKeyEnv():
    return os.environ.get("TWEETUSERNAME", "pXLAAQkAx")


def GetConsumerSecretEnv():
    return os.environ.get("TWEETPASSWORD", "9nJasdkLDI12WEFWIEFWaLT")


def GetAccessKeyEnv():
    return os.environ.get("TWEETACCESSKEY", "82T")


def GetAccessSecretEnv():
    return os.environ.get("TWEETACCESSSECRET", "pFvZAdpuUy")
